      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-footer">
          ...
          <div className="footer-actions">
            ...
            <button onClick={() => router.push('/settings/password')} className="icon-btn" title="Security Settings">
              <Lock size={16} />
            </button>
